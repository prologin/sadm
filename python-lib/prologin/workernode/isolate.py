...
#            #####################
#
# This file was imported from the Camisole project.
# As long as we haven't figured a good solution to share code between the two
# projects (maybe requiring the "camisole" package from pip?), it is advised to
# AVOID MAKING ANY CHANGES to this file, in order to keep it consistent with
# Camisole.
