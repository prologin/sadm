...
0. Setup mitogen (a fast drop-in replacement for Ansible runtime) by running
   $ source activate_mitogen.sh
   in this directory.

1. Follow https://prologin-sadm.readthedocs.io/en/latest/containers.html until
   it asks you to run ./container_setup_host.sh. This will create an
   arch_linux_base image in /var/lib/machines that you will use to spawn new
   machines.
